            ...
            <Slide bottom>
                <div className={style.projectsContainer}>
                    ...
                    <div className={style.projects}>
                        <ProjectItem style={todoBackStyle} refer={'https://dubrovskayadarya.github.io/ToDoList/'}
                                     projectTitle={'ToDoList'}
                                     projectDescription={'Used technologies: React, TypeScript, Redux, REST API, redux-thunk, axios requests, Material-UI. The application meets the requirements of the FLUX architecture.'}/>
                        ...
                        <ProjectItem style={cardsBackStyle} refer={'https://anyagalkina.github.io/cards/'}
                                     projectTitle={'Educational Cards'}
                                     projectDescription={'Technologies used: React, Redux, REST API, axios, react-redux, react-paginate, react-router-dom v6, redux-thunk.'}/>
                    </div>
                </div>
            </Slide>
        </div>
